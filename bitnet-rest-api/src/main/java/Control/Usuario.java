    ...
    public String autenticar(String usuario, String contrasena) {
        ...
        try {
            ...
            try {
                ...
                resultado = "PROYECTO: bitnet-rest-api, CLASE: " + this.getClass().getName() + ", METODO: rollback-autenticar(), ERRROR: " + ex.toString();
            }
        } finally {
            try {
                if (conn != null) {
                ...
                resultado = "PROYECTO: bitnet-rest-api, CLASE: " + this.getClass().getName() + ", METODO: finally-autenticar(), ERRROR: " + ex.toString();
            }
        }

...
public class Plantilla implements Serializable {
    ...
    public void onload(UsuarioSesion usuario_sesion) {
        try {
            ...
            System.out.println("PROYECTO: bitnet-web-app, CLASE: " + this.getClass().getName() + ", METODO: onload(), ERRROR: " + ex.toString());
        }
    }
    ...
    public String logout() {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Mensaje del sistema.", ex.toString()));
            System.out.println("PROYECTO: bitnet-web-app, CLASE: " + this.getClass().getName() + ", METODO: logout(), ERRROR: " + ex.toString());
    ...
    public Boolean render_menu(String menu) {
        ...
        try {
            ...
            FacesContext.getCurrentInstance().addMessage(null, new FacesMessage(FacesMessage.SEVERITY_ERROR, "Mensaje del sistema.", ex.toString()));
            System.out.println("PROYECTO: bitnet-web-app, CLASE: " + this.getClass().getName() + ", METODO: render_menu(), ERRROR: " + ex.toString());
            resultado = false;
        }

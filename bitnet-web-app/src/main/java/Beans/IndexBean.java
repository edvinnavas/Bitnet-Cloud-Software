    ...
    public String autenticar() {
        ...
        try {
            ...
            if (!json_result.equals("Usuario no autenticado.")) {
                this.usuario_sesion.setId_usuario(Long.valueOf("1"));
                this.usuario_sesion.setNombre_usuario(this.txt_usuario);
                this.usuario_sesion.setNombre_sesion_usuario("Edvin Francisco Navas Mejía");
                this.usuario_sesion.setContrasena_usuario(this.pass_contrasena);
